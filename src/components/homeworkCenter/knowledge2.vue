      ...
      <el-row :gutter="20">
        ...
        >
          <div class="grid-content">
            <Subject ref="subject" :style="shrink ? '' : 'width:0;overflow:hidden'"></Subject>
            ...
            <table>
              <thead>
                <tr style="background-color:#f8f8f8;">
                  ...
                  <td style="color:#fb8b22;font-size:16px;padding:5px">展示分类</td>
              ...
              <tbody>
                ...
                >
                  ...
                  <td style="padding:10px;font-size:14px">{{ item.source }}</td>
                  <td style="padding:10px;font-size:14px">{{ item.createTime }}</td>
                  <td @click="deleteQuestion(item)">
        ...
        >
          <div class="subject">
            ...
            <div class="import-out">
              ...
              <div class="wordTest" v-for="(item, index) in problems" :key="index" v-show="isShow">
                ...
                <div class="anser-score">
                  ...
                  <el-input style="width:50px" v-model="questionScore"></el-input>
                  <span>&nbsp;分</span>
                </div>
                <div class="anserType">
                  <div class="anserList">
                    ...
                    <el-button
                      ...
                      :key="indexs"
                      :class="QuestionType2indexs == indexs ? 'choores' : ''"
                      @click="chooseTypes(items, indexs)"
                  ...
                  <div class="anserList">
                    ...
                    <el-button
                      ...
                      :class="{ active: num2s == indexs }"
                      :key="indexs"
                      @click="chooseDifficulty(items, indexs)"
                    >{{ items.name }}</el-button>
                  </div>
                  <div class="anserList">
                  ...
                  <div class="anserList">
                    ...
                    <el-button
                      ...
                      :key="indexs"
                      :class="{ active: targetNums == indexs }"
                      @click="chooseTarget(items, indexs)"
                    >{{ items.name }}</el-button>
                  </div>
                  <div class="label">
                    选择输入语音:
                  ...
                  <div class="right" style="margin-left:350px;margin-bottom:50px">
                    <el-button
                      type="primary"
                      class="confirm"
                      id="confirmBtn"
                      @click="confirmS(item, index)"
                    >确定</el-button>
                    <el-button
                      type="warning"
                      class="delete"
                        ...
                        <div class="contentTitle">
                          <ul>
                            <li>
                              ...
                              <input type="file" :id="'file_' + index" @change="UploadImages" />
                            </li>
                          </ul>
                        </div>
                        <div
                      ...
                      <div class="sort">
                        ...
                        <div class="li">
                          ...
                          <div class="btn">
                            <el-button
                              v-for="(items, indexs) in difficulty"
                              :class="{ active: num2[index] == indexs }"
                              :key="indexs"
                              @click="chooseDifficulty(items, indexs,index)"
                            >{{ items.name }}</el-button>
                          </div>
                        </div>
                        <!-- <div class="li">
                        ...
                        <div class="li">
                          ...
                          <div class="btn">
                            <el-button
                              v-for="(items, indexs) in target"
                              :key="indexs"
                              :class="{ active: targetNum[index] == indexs }"
                              @click="chooseTarget(items, indexs,index)"
                            >{{ items.name }}</el-button>
                          </div>
                        </div>
                      </div>
...
var m1 = {
  ...
  created() {
    this.intoId = this.$route.query.intoId;
    var that = this;
  ...
  methods: {
    ...
    deleteQuestion(item) {
      ...
      this.$confirm("此操作将删除此题, 是否继续?", "提示", {
        ...
        .then(() => {
          this.$axios
            // /homework/delete
            .delete("/user/homework/delete?id=" + item.id)
            .then(res => {
              // console.log(res);
              if (res.code == "5000") {
    ...
    addTest(item, index) {
      ...
      var len = this.problem.length;
      for (let i = 0; i < len; i++) {
        this.num2.push(0);
        this.targetNum.push(0);
      }
    ...
    chooseDifficulty(items, indexs, inidex) {
      this.problems[inidex] = indexs;
    ...
    chooseTarget(items, indexs, index) {
      this.problems[index] = indexs;
