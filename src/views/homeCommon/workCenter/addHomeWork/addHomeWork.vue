<template>
  <div class="addTest">
    <div class="box" style="padding-top:20px;padding-bottom:15px">
      <div class="right">
        <div style="width:60%">
          <TaskHeader style="width:75%" />
          ...
          <div class="wordTest" v-for="(item, r) in problems" :key="r">
            ...
            <div class="anser-conter">
              <p>
                答案:
                <!-- <el-button
                  v-if="form.typeName!='单选题'"
                  @click="importTxt('questionAnser',r)"
                  size="mini"
                  style="margin-bottom:5px"
                >引入</el-button>-->
              </p>
              <el-select v-model="form.answer" v-if="form.typeName=='单选题'" placeholder="请选择">
            ...
            <div class="anser-score">
              ...
              <el-select v-model="form.questionScore" placeholder="请选择分数">
                <el-option v-for="i in 70" :key="i" :label="i" :value="i"></el-option>
              </el-select>
            ...
            <div class="anserType">
              <div class="anserList">
                ...
                <el-radio-group v-model="form.typeName" size="small" @change="radioChange">
                  <el-radio-button
...
export default {
  ...
  methods: {
    ...
    confirmSd(item, index) {
      let data = {
        chapterId: sessionStorage.getItem("sectionId"),
      ...
      this.$post(this.$parent.api, data).then(res => {
        if (res.code == "5000") {
          ...
          let api;
          if (!this.$parent.publishType) {
            api = "/user/homework/question/insert";
            this.$parent.collectApi({ id: res.data, type: 3 });
          }
          ...
          console.log(...this.$store.state.allproblemslist);
          // if (
          //   this.problem.findIndex((item, indexs) => indexs === index) != "-1"
          // ) {
          //   this.problem.splice(index, 1, data);
          //   newList.splice(
          //     newList.findIndex(item => item.id == this.problem[index].id),
          //     1,
          //     data
          //   );
          // } else {
          //   this.problem.push(data);
          //   newList.push(data);
          // }
          newList.push(data);
          this.allProblems = newList.length + this.problems.length;
          this.allproblemslist = newList;
          this.$store.commit("setAllproblemslist", this.allproblemslist);
          // this.$router.push({
