      ...
      <div class="box">
        ...
        <div class="right">
          <div class="imgBox">
            ...
            <div class="searchItem">
              <el-button @click="goRou" type="primary" size="mini">返回</el-button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    add(data) {
      this.$prompt("请输入备用习题分数", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        inputPattern: /^[0-9]*$/,
        inputErrorMessage: "请输入数字"
      }).then(({ value }) => {
        data.sameId = sessionStorage.getItem("sameId");
        data.score = value;
        data.sort = "";
        data.sound = "";
        data.createTime = "";
        this.$post(this.$parent.api, data).then(res => {
          if (res.code == 5000) {
            this.$message({ type: "success", message: "添加备用习题成功" });
          } else {
