<template>
  <div>
            ...
            <div class="con submit-test-dialog">
              ...
              >
                ...
                <el-form-item
                  ...
                  prop="horizontal"
                  class="bj"
                  style="width:30%;margin-left:115px;"
                >
    ...
    <div class="confirm" id="printMe">
      <el-button type="warning" class="myBtn1" @click="shows" v-if="contentName">发布</el-button>
...
export default {
  ...
  created() {
    ...
    this.list = JSON.parse(sessionStorage.getItem("researchList"));
    //  console.log(this.workId);
    if (this.list != null) {
      var workIds = sessionStorage.getItem("researchWorkId");
  ...
  methods: {
    ...
    shows() {
      ...
      if (this.list != null) {
        ...
        data.total = sessionStorage.getItem("researchTotal");
      } else if (this.list == null) {
        data.total = this.questionsConter.score;
        data.questionIds = this.questionsConter.id;
      }
      this.$post("/user/research/homework/insert", data).then(res => {
        if (res.code == "5000") {
          ...
          setTimeout(function() {
            ...
            sessionStorage.removeItem("researchWorkId");
            sessionStorage.removeItem("researchList");
            sessionStorage.removeItem("researchTotal");
          }, 2000);
        }
      });
    },
    //根据id获取作业
    getQuestion() {
      this.$get("/user/research/question/findById", {
        id: this.homeworkId
      }).then(res => {
