<template>
  <div>
    <div class="subject">
      <goBack :direction="true" link="/homeCommon/TeachingResearch/addHomeWork"></goBack>
  ...
  methods: {
    ...
    againEdit() {
      this.$router.push({
        ...
        query: { homeworkId: this.$route.query.homeworkId, pid: this.pid }
      });
    },
    //创建班级
    submitFormq(data) {
    ...
    saveHomeword() {
      ...
      let api;
      this.homeworkId
        ? (api = "/user/research/homework/update")
        : (api = "/user/research/homework/insert");
