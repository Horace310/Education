<template>
  <div class="setting bf">
    <div class="setting-con bx" style="padding-left:150px">
      <div class="changePassword" v-show="showt">
        ...
        >
          ...
          <el-form-item>
            <el-button type="primary" size="mini" class="apply" @click="submitForm('ruleForm2')">确定</el-button>
          </el-form-item>
        </el-form>
      </div>
      ...
      <!-- <div class="changePassword">
        <p class="tit ft18 myColor col39a">找回密码问题设置</p>
        <el-form status-icon ref="ruleForm2" label-width="100px" class="demo-ruleForm">
          <el-form-item label="问题1" prop="phone">
            <el-input type="text" clearable maxlength="11"></el-input>
          </el-form-item>
          <el-form-item label="答案1" prop="phone">
            <el-input type="text" clearable maxlength="11"></el-input>
          </el-form-item>
          <el-form-item label="问题2" prop="phone">
            <el-input type="text" clearable maxlength="11"></el-input>
          </el-form-item>
          <el-form-item label="答案2" prop="phone">
            <el-input type="text" clearable maxlength="11"></el-input>
          </el-form-item>
          <el-form-item prop="phone">
            <el-button style="background-color:#2ab8b3;color:#fff;border:0;width:150px">确认</el-button>
          </el-form-item>
        </el-form>
      </div>-->
    </div>
  ...
  methods: {
    ...
    getAuthCode1(e) {
      if (this.count1 == 60) {
        ...
        this.$get("/user/GetVerificationCode", { mobile: e }).then(res => {
          if (res.code == "5000") {
            // console.log(res);
            this.$message({
              showClose: true,
    ...
    submitForms(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.$get("/user/modify/phone", data).then(response => {
            if (response.code == "5000") {
              this.$message({
                showClose: true,
                message: "换绑成功!",
